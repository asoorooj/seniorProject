...
textCheckpoint = torch.load("C:\\Users\\MEETS_PC\\Documents\\VScode\\new\\seniorProject\\aiModels\\languageModel\\combined_model.pth", map_location=device)
...
ckpt  = torch.load("C:\\Users\\MEETS_PC\\Documents\\VScode\\new\\seniorProject\\aiModels\\facialModel\\fer_ck_finetuned_inference.pth", map_location=device)
...
cnn.load_state_dict(torch.load("C:\\Users\\MEETS_PC\\Documents\\VScode\\new\\seniorProject\\aiModels\\audioModel\\audio_model_cnn.pth", map_location=device))

W_CNN = 0.60
W_SVM = 0.40

svm = joblib.load("C:\\Users\\MEETS_PC\\Documents\\VScode\\new\\seniorProject\\aiModels\\audioModel\\svm_model_for_fusion.joblib")
