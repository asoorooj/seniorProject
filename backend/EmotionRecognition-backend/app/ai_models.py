...
textCheckpoint = torch.load("../../backend/EmotionRecognition-backend/app/modelWeights/combined_model.pth", map_location=device)
...
ckpt  = torch.load("../../backend/EmotionRecognition-backend/app/modelWeights/fer_ck_finetuned_inference.pth", map_location=device)
...
cnn.load_state_dict(torch.load("../../backend/EmotionRecognition-backend/app/modelWeights/audio_model_cnn.pth", map_location=device))

W_CNN = 0.60
W_SVM = 0.40

svm = joblib.load("../../backend/EmotionRecognition-backend/app/modelWeights/svm_model_for_fusion.joblib")
